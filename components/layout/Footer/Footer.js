    ...
    return (
        <footer >
            <svg id="wave" style={{transform: 'rotate(0deg)', transition: '0.3s'}} viewBox="0 0 1440 110"
                ...
                <path style={{transform: "translate(0, 0px)", opacity: "1"}} fill="#F77426"
            ...
            <div className={'bg-primary'}>
                <div className="w-3/4 py-12 px-8 mx-auto">
            ...
            <div className={'border-t border-black border-opacity-20'}>
                <div className="container px-16 py-4 mx-auto flex flex-wrap items-center sm:flex-row flex-col">
                    <div className={'md:w-1/2 w-full flex flex-wrap items-center justify-center mt-4 '}>
